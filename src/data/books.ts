...
export const bookCategories: BookCategory[] = [
  {
    ...
    books: [
      { title: "Clean Code", author: "Robert C. Martin", featured: true },
      { title: "The Clean Coder", author: "Robert C. Martin" },
      { title: "Clean Architecture", author: "Robert C. Martin" },
      { title: "The Pragmatic Programmer", author: "Andy Hunt & Dave Thomas", featured: true },
      { title: "Code Complete", author: "Steve McConnell" },
      { title: "Domain-Driven Design", author: "Eric Evans", featured: true },
      { title: "Refactoring", author: "Martin Fowler", featured: true },
      ...
      { title: "Test-Driven Development: By Example", author: "Kent Beck", featured: true },
      { title: "Continuous Delivery", author: "Jez Humble & David Farley" },
      { title: "Continuous Integration", author: "Paul Duvall" },
      { title: "Release It!", author: "Michael T. Nygard" },
      { title: "xUnit Test Patterns", author: "Gerard Meszaros" },
      { title: "The Software Craftsman", author: "Sandro Mancuso" },
      { title: "Geek Sublime", author: "Vikram Chandra" },
    ],
  },
  {
    ...
    books: [
      ...
      { title: "Succeeding with Agile", author: "Mike Cohn" },
      { title: "Essential Scrum", author: "Kenneth S. Rubin" },
      { title: "Kanban", author: "David J. Anderson" },
      { title: "Coaching Agile Teams", author: "Lyssa Adkins" },
      { title: "Agile Retrospectives", author: "Esther Derby & Diana Larsen" },
      { title: "Agile Project Management with Scrum", author: "Ken Schwaber" },
      { title: "Scrum Guide", author: "Ken Schwaber & Jeff Sutherland" },
    ],
  },
];
